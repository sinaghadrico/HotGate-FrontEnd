...
interface FastPoolInterface extends ethers.utils.Interface {
    functions: {
...
export class FastPool extends BaseContract {
    ...
    functions: {
        ...
        totalRequestedAmount(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        totalRequestedAmount(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
