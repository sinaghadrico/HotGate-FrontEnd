...
interface BitcoinTeleporterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "teleportersList(uint256)": FunctionFragment;
    "unlockFee()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "teleportersList",
    values: [BigNumberish]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "lastUnlock", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "multiSigAddress",
    data: BytesLike
  ): Result;
...
export class BitcoinTeleporter extends BaseContract {
  ...
  interface: BitcoinTeleporterInterface;

  functions: {
    TeleportDAOToken(overrides?: CallOverrides): Promise<[string]>;

    addTeleporter(
      _teleporterBitcoinAddress: BytesLike,
    ...
    lastUnlock(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    teleportersList(
      ...
      [string, string] & {
        teleporterBitcoinAddress: string;
        teleporterAddress: string;
      }
    >;

    unlockFee(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    lastUnlock(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    unlockFee(overrides?: CallOverrides): Promise<PopulatedTransaction>;
