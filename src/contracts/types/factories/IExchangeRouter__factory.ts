...
import type { IExchangeRouter, IExchangeRouterInterface } from "../IExchangeRouter";
...
export class IExchangeRouter__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IExchangeRouter {
