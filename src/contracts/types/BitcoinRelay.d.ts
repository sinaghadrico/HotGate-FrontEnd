...
interface BitcoinRelayInterface extends ethers.utils.Interface {
    functions: {
        ...
        "keepersList(uint256)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "HEIGHT_INTERVAL", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "chain", values: [BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "keepersList", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "HEIGHT_INTERVAL", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "keepersList", data: BytesLike): Result;
...
export class BitcoinRelay extends BaseContract {
    ...
    functions: {
        ...
        keepersList(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string] & { keeperAddress: string }>;
    ...
    keepersList(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        addKeeper(_keeperAddress: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    ...
    estimateGas: {
        ...
        chain(arg0: BigNumberish, arg1: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        keepersList(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        chain(arg0: BigNumberish, arg1: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        keepersList(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
