...
interface IFastRouterInterface extends ethers.utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getNeededConfirmations", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getNeededConfirmations", data: BytesLike): Result;
...
export class IFastRouter extends BaseContract {
    ...
    populateTransaction: {
        ...
        getNeededConfirmations(overrides?: CallOverrides): Promise<PopulatedTransaction>;
